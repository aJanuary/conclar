...
const FilterableProgram = () => {
  ...
  /**
   * When reset filters pressed, reset the program filters. Clearing the
   * filters must also drop any /loc/ URL, otherwise a refresh restores the
   * location filter from the path.
   */
      ...
      <div className="filter" role="search">
        ...
        <div className="reset-filters">
          <ResetButton
            ...
            resetFilters={resetFiltersAndNavigate}
          />
        </div>
        {limitDropDown()}
